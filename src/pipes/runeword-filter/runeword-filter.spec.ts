import { RuneWordFilterPipe } from './runeword-filter'
...
describe('RuneWordFilterPipe', () => {
  ...
  it('should transform input based on Item Type', () => {
    ...
    // Item Type: Armor
    const runewordsFilteredByItemTypeArmor = pipe.transform(runeWordDataService.getData(), ['Armor'], [], [], []);
    expect(runewordsFilteredByItemTypeArmor.length).toEqual(20);

    // Item Type: Helm
    const runewordsFilteredByItemTypeHelm = pipe.transform(runeWordDataService.getData(), ['Helm'], [], [], []);
    expect(runewordsFilteredByItemTypeHelm.length).toEqual(5);

    // Item Type: Shield
    const runewordsFilteredByItemTypeShield = pipe.transform(runeWordDataService.getData(), ['Shield'], [], [], []);
  ...
  it('should transform input based on Weapon Class', () => {
    ...
    // Weapon Class: Club
    const runewordsFilteredByWeaponClassClub = pipe.transform(runeWordDataService.getData(), ['Weapon'], ['Club'], [], []);
    ...
    expect(runewordsFilteredByWeaponClassMissile.length).toEqual(17);

    // Weapon Class: Orb
    const runewordsFilteredByWeaponClassOrb = pipe.transform(runeWordDataService.getData(), ['Weapon'], ['Orb'], [], []);
    ...
    const runewordsFilteredByAllWeaponClasses = pipe.transform(runeWordDataService.getData(), ['Weapon'],
      ['Axe', 'Claw', 'Club', 'Hammer', 'Mace', 'Missile', 'Orb', 'Polearm', 'Scepter', 'Staff', 'Sword', 'Wand'], [], []);
    ...
    const runewordsFilteredByAllWeaponClassesWithoutWeaponItemType = pipe.transform(runeWordDataService.getData(), [],
      ['Axe', 'Claw', 'Club', 'Hammer', 'Mace', 'Missile', 'Orb', 'Polearm', 'Scepter', 'Staff', 'Sword', 'Wand'], [], []);
  ...
  it('should transform input based on No. of Sockets', () => {
    ...
    // No. of Sockets: 2
    const runewordsFilteredByNumberOfSockets2 = pipe.transform(runeWordDataService.getData(), [], [], ['2'], []);
    expect(runewordsFilteredByNumberOfSockets2.length).toEqual(13);

    // No. of Sockets: 3
    const runewordsFilteredByNumberOfSockets3 = pipe.transform(runeWordDataService.getData(), [], [], ['3'], []);
    expect(runewordsFilteredByNumberOfSockets3.length).toEqual(30);

    // No. of Sockets: 4
    const runewordsFilteredByNumberOfSockets4 = pipe.transform(runeWordDataService.getData(), [], [], ['4'], []);
    ...
    const runewordsFilteredByNumberOfSockets2And3 = pipe.transform(runeWordDataService.getData(), [], [], ['2', '3'], []);
  ...
  it('should transform input based on Runes', () => {
    ...
    // Runes: Zod
    const runewordsFilteredByRunesZod = pipe.transform(runeWordDataService.getData(), [], [], [], ['Zod']);
